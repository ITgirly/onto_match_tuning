...
{\bf Falcon-AO}	& Wei Hu											& http://ws.nju.edu.cn/falcon-ao/									& 26			& $\surd$		& $\surd$				& $\surd$	\\
{\bf GMap}		& Weizhuo Li 										& http://ceur-ws.org/Vol-1545/om2015\_TSpaper1.pdf					& 3				& $\surd$		& $\surd$				&  			\\
{\bf Lily}		& Peng Wang											& https://link.springer.com/article/10.1007/s11432-014-5237-y		& 13, 18		& $\surd$		& $\surd$				& $\surd$	\\
{\bf LogMap}		& Bernardo Cuenca Grau,Ernesto Jimenez-Ruiz	& https://www.cs.ox.ac.uk/isg/tools/LogMap/ 						& 10			& $\surd$		& $\surd$				& $\surd$	\\
{\bf OLA}			& J Euzenat		 									& https://hal.inria.fr/hal-00918128/document 						& 26			& $\surd$		& $\surd$				&  			\\
{\bf RiMOM}		& Juanzi Li,Jie Tang								& https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=\&arnumber=4633358	& 5				& $\surd$		&  $\surd$				&  	 		\\
{\bf XMap}		& Warith Eddine Djeddi,Mohamed Tarek Khadir 	& https://link.springer.com/content/pdf/10.1007\%2F978-3-319-10160-6\_29.pdf& 5		& $\surd$		&   $\surd$				&  			\\ \bottomrule
\end{tabular}}
\end{table}
%\begin{table}[ht]
%\centering
...
%\begin{tabular}{@{}ccccccc@{}}
%\toprule
%System	& Falcon-AO	& GMap	& Lily	& LogMap	& OLA	& RiMOM	& XMap	\\ \midrule
%developer	& Wei Hu	& Weizhuo Li	& Weizhuo Li	& Peng Wang	& Bernardo Cuenca Grau	& J Euzenat	& Juanzi Li, Jie Tang	& Warith Eddine Djeddi, Mohamed Tarek Khadir
%link
...
\begin{subfigure}{0.3\textwidth}
	\centering
\includegraphics[width=\textwidth]{data_figs/MulRegress_OLA_R.pdf}
\caption{Recall}
\label{fig:MultiRegress_OLA_R}
\end{subfigure}
\caption{results of OLA}
\end{figure}


The Table 3.4 summarizes the results of parameter tuning of different systems on different data sets. Among them, $Ratio@P$, $Ratio@R$, $Ratio@F1$ represent the ratio of the result of the tuning to the accuracy of the ideal situation.
...
From figure\ref{fig:benchmark_101_Recall}, the task NO.101 of the benchmark dataset, the original ontology, matches itself.
...
It can be seen from figure\ref{fig:benchmark_101_Recall} that the effects of the LogMap system and the XMap system have been significantly improved by the methods, and both have achieved the effect of tuning using the LHS-PSO method.
...
%\begin{subfigure}{\textwidth}
%	\centering
%\includegraphics[width=0.5\textwidth]{data_figs/benchmark_248-266_F1-Measure.pdf}
%\caption{F1-Measure}
...
%\begin{subfigure}{\textwidth}
%	\centering
%\includegraphics[width=0.49\textwidth]{data_figs/benchmark_248-266_Precision.pdf}
%\caption{Precision}
%\label{fig:benchmark_248-266_Precision}
%\end{subfigure}
%\begin{subfigure}{\textwidth}
%	\centering
%\includegraphics[width=0.49\textwidth]{data_figs/benchmark_248-266_Recall.pdf}
%\caption{Recall}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{data_figs/MulRegress_benchmark_F1.pdf}
	\captionof{figure}{The F1-Measure of each system on benchmark}
	\label{fig:MulRegress_benchmark_F1}
\end{minipage}
\begin{minipage}{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{data_figs/MulRegress_conference_F1.pdf}
	\captionof{figure}{The F1-Measure of each system on conference}
	\label{fig:MulRegress_conference_F1}
\end{minipage}
\begin{minipage}{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{data_figs/MulRegress_conference_F1.pdf}
	\captionof{figure}{The F1-Measure of each system on anatomy}
...
\begin{subfigure}{\textwidth}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/sl_legend.pdf}
\end{subfigure}
\begin{minipage}{0.5\textwidth}
	\centering
	\setlength{\abovecaptionskip}{0pt}
	\setlength{\belowcaptionskip}{0pt}
	\includegraphics[width=\textwidth]{data_figs/strategy_Lily.pdf}
	\captionof{figure}{the strategy tuning result of Lily on anatomy}
...
\begin{subfigure}{\textwidth}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/s_legend.pdf}
\end{subfigure}
\begin{minipage}{0.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{data_figs/strategy_benchmark.pdf}
	\captionof{figure}{The result of strategy tuning on benchmark}
	\label{fig:strategy_benchmark}
\end{minipage}%
\begin{minipage}{0.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{data_figs/strategy_conference.pdf}
	\captionof{figure}{The result of strategy tuning on conference}
